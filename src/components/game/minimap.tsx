...
import { FddLayoutEntryMeta, FddMapEntryMeta } from '../../types';
          ...
          if (refreshAt < cTime) {
            if (props.game.player && data.value.player) {
              const playerPosition: [number, number] = [
                gameToMapSpace[0](props.game.player.rust.obj.position[1]),
                gameToMapSpace[1](props.game.player.rust.obj.position[0]),
              ];
              if (
