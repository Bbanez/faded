...
#[ts(export)]
pub struct GameMapLandscapeChunk {
    pub id: u32,
    pub mesh_id: u32,
    pub set_id: u32,
    pub y: u32,
...
impl GameMapLandscapeChunk {
    pub fn new(chunk: (u32, u32), map_width: u32, map_depth: u32) -> GameMapLandscapeChunk {
        GameMapLandscapeChunk {
