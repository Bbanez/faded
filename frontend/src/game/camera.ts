...
export class Camera {
  ...
  private calcPosition() {
    if (this.followObj) {
      if (
        this.position.wanted[0] !== this.followObj.go.boundingBox.position.x ||
        this.position.wanted[2] !== this.followObj.go.boundingBox.position.y
      ) {
        this.position.wanted = [
          this.followObj.go.boundingBox.position.x,
          Distance.heightTo(
            [this.followObj.go.boundingBox.position.x, this.followObj.go.boundingBox.position.y],
            this.game.assets.ground,
          ),
          this.followObj.go.boundingBox.position.y,
        ];
      }
    }
    if (
